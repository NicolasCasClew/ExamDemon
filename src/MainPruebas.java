...
public class MainPruebas {
    ...
    //Instancia
    private static RandomAccessIO randomAccessIO = new RandomAccessIO(path+"prueba.dat");
    public static void main(String[] args) {
        ...
        randomAccessIO.writeFile(RandomAccessIO.BYTES.INT,3);
        ...
        for(int cum: idPos){
            System.out.println("Cumboi = "+cum);
        }
        //Inicio de escritura
        randomAccessIO.initWriter();

        //Escribe/Sobreescribe en la posición pasada por parámetro
        randomAccessIO.writeFileByPos(RandomAccessIO.BYTES.INT,69,idPos[1]);
